...
export const FALLBACK_PRODUCTS: Product[] = [
  {
    ...
    storyDescription: 'Nestled in the pristine Himalayan foothills of Tanakpur, Champawat (Uttarakhand), our indigenous Gir & Sahiwal cows graze freely on mineral-rich hill pastures and drink pure mountain spring water. Crafted using the ancient Vedic Bilona method, A2 cultured curd is slow-churned to yield pure makkhan, which is then gently simmered in traditional pots to produce rich, golden ghee with an authentic granular texture, divine aroma, and uncompromised Himalayan purity.',
    price: '1450',
    originalPrice: '1600',
    discountBadge: '9% OFF',
    badge: '★ Best Seller',
