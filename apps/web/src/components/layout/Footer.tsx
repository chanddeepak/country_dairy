  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          <h4 className="text-[10px] uppercase tracking-[0.22em] text-[var(--brass)] mb-5">Shop</h4>
        ...
        <div>
          <h4 className="text-[10px] uppercase tracking-[0.22em] text-[var(--brass)] mb-5">Support and contact</h4>
          <div className="text-[13px] leading-relaxed grid gap-2 font-light">
            ...
            <p className="m-0">
              WhatsApp orders{' '}
              <a href="https://wa.me/919997801112" target="_blank" rel="noreferrer" className="text-[var(--brass)] hover:text-white transition-colors">
                +91 99978 01112
              </a>
            </p>
        ...
        <div>
          <h4 className="text-[10px] uppercase tracking-[0.22em] text-[var(--brass)] mb-5">Ask us anything</h4>
