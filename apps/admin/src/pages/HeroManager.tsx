      ...
      .then(banners => {
        if (banners && banners.length > 0) {
          const mapped: HeroSlide[] = banners.map(b => ({
            ...
            desktopImageUrl: (b.imageUrl && !b.imageUrl.startsWith('blob:') && !b.imageUrl.startsWith('/images/')) ? b.imageUrl : '',
            mobileImageUrl: (b.imageUrl && !b.imageUrl.startsWith('blob:') && !b.imageUrl.startsWith('/images/')) ? b.imageUrl : '',
            overlayOpacity: 30,
